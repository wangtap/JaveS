...
public class GetCityList {
    ...
    public static String excute(){
        String url="http://v.juhe.cn/weather/index?format=2&cityname=%E6%AD%A6%E6%B1%89&key=3c5c839d9f73f6217e504371e9611120";//接口URL
    ...
    public static void main(String[] args) {
        System.out.println(getIDBycityName("武汉"));
    }
}