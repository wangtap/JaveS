...
<table border="1" width="100%" cellspacing="0" background="black">
	<tr bgcolor="gray" bordercolor="gray">
		<td colspan="6">
			订单编号：${requestScope.get('orders').getOid()}　
			成交时间：${requestScope.get('orders').getOrderTime()}　
			金额：<span color="red"><b>${requestScope.get('orders').getPrice()}</b></span>
		</td>
	</tr>
	<c:forEach var="orderitem" items="${requestScope.get('orderItems')}">
