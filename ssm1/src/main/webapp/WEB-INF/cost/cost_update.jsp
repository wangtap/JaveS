...
<div id="main">
    ...
    <form action="${pageContext.request.contextPath}/cost/update" method="post" class="main_form">
        ...
        <div class="input_info"><input name="id" type="text" class="readonly" readonly value="${cost.id}" /></div>
        ...
        <div class="input_info">
            <input name="baseDuration" type="text" value="${cost.baseDuration}" class="width100" />
        ...
        <div class="input_info">
            <input name="baseCost" type="text" value="${cost.baseCost}" class="width100" />
        ...
        <div class="input_info">
            <input name="unitCost" type="text" value="${cost.unitCost}" class="width100" />
