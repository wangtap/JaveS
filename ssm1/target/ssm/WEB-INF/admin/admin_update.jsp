...
<div id="main">
    ...
    <form action="${pageContext.request.contextPath}/admin_info/update" method="post" class="main_form">
        <input name="adminId" value="${extendAdminInfo.adminId}" hidden>
        <div class="text_info clearfix"><span>姓名：</span></div>
        <div class="input_info">
            <input name="name" type="text" value="${extendAdminInfo.name}" />
            <span class="required">*</span>
            <div class="validate_msg_long error_msg">20长度以内的汉字、字母、数字的组合</div>
        </div>
        <div class="text_info clearfix"><span>管理员账号：</span></div>
        <div class="input_info"><input name="adminCode" type="text" readonly="readonly" class="readonly" value="${extendAdminInfo.adminCode}"  /></div>
        <div class="text_info clearfix"><span>电话：</span></div>
        <div class="input_info">
            <input name="telephone" type="text" value="${extendAdminInfo.telephone}"  />
            <span class="required">*</span>
            <div class="validate_msg_long error_msg">正确的电话号码格式：手机或固话</div>
        </div>
        <div class="text_info clearfix"><span>Email：</span></div>
        <div class="input_info">
            <input name="email" type="text" class="width200" value="${extendAdminInfo.email}"/>
            <span class="required">*</span>
