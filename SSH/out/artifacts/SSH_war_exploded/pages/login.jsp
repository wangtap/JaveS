	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1" >
		...
		<tr align="center" >
			...
			<td class="login_msg" width="400">
				<s:form action="staff_login" method="post">
					...
					<br/>
					用户名：<s:textfield type="text" name="staff.loginName" class="msg" value="xiaowang"  /><br/><br/>
					密&nbsp;码：<s:textfield type="password" name="staff.loginPwd" class="msg" value="123456" /><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<s:submit type="submit" class="btn" value="登录 " />
