...
public class WeatherReportByCity {
    ...
    public static String excute(String cityName){
        String url=//此处以返回json格式数据示例,所以format=2,以根据城市名称为例,cityName传入中文
                "http://v.juhe.cn/weather/index?cityname="+cityName+"&key=3c5c839d9f73f6217e504371e9611120";
//        http://v.juhe.cn/weather/index?format=2&cityname=%E6%AD%A6%E6%B1%89&key=3c5c839d9f73f6217e504371e9611120
